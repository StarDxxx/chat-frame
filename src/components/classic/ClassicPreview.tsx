      ...
      <div className="flex-1 relative">
        <div style={{ padding: "34px 24px 22px", display: "flex", flexDirection: "column", gap: 26 }}>
          {turns.map((turn) => {
            ...
            return (
              <div key={turn.id} style={{ width: "100%", display: "flex", justifyContent: "flex-start" }}>
                {settings.showAvatars && (
...
function ChatGPTInputBar() {
  return (
    ...
    >
      ...
      >
        <Plus size={22} strokeWidth={1.8} color="#111" style={{ flexShrink: 0 }} />
        <span
          style={{
            flex: 1,
            minWidth: 0,
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4, color: "#8a8a8a", fontSize: 13, flexShrink: 0 }}>
          <span>Instant</span>
          <ChevronDown size={13} strokeWidth={2} />
        </div>
        <Mic size={20} strokeWidth={2.15} color="#111" style={{ flexShrink: 0 }} />
      </div>
      <p
        style={{
          margin: "8px 0 0",
...
function ClaudeVoiceBars() {
  return (
    <div style={{ width: 20, height: 20, display: "flex", alignItems: "center", justifyContent: "center", gap: 2, color: "#2d2b28" }}>
      {[8, 14, 17, 12, 16].map((height, index) => (
        <span
          key={index}
          style={{
            width: 1.5,
...
function ClaudeInputBar() {
  return (
    ...
    >
      ...
      >
        <div style={{ color: "#838079", fontSize: 13, lineHeight: 1.15 }}>Write a message...</div>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <Plus size={19} strokeWidth={1.6} color="#2d2b28" />
          <div style={{ flex: 1 }} />
          <div style={{ display: "flex", alignItems: "center", gap: 4, color: "#33302c", fontSize: 12 }}>
      ...
      <p style={{ margin: "6px 0 0", textAlign: "center", color: "#7c766c", fontSize: 10, lineHeight: 1.25 }}>
  ...
  return (
    ...
    >
      <div className="flex-1 relative">
        ...
        >
          {(() => {
            const lastAiIndex = turns.map(t => t.role).lastIndexOf("assistant")
                ...
                <div key={turn.id} style={{ maxWidth: "86%" }}>
                  ...
                  {index === lastAiIndex && (
                    <div style={{ marginTop: 8, opacity: 0.75 }}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 256 257">
