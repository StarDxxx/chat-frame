      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-8 px-6 py-8 max-w-5xl mx-auto w-full">
        ...
        <div className="flex-1 flex items-start justify-center">
          <div className="w-full max-w-sm">
            <CardPreview turns={turns} themeId={themeId} platform={platform} settings={{ showAvatars: true, showFooter: true, showDate: false, sizeId: "xiaohongshu", layoutFlow: "bottom-up", fontSize: 12, avatarUser: "我", avatarAI: "", fontId: "noto-serif-sc" }} />
          </div>
        </div>
